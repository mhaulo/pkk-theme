...
function restaurant_and_cafe_banner_cb(){
	...
	if( !is_page_template( 'template-home.php' ) || !$restaurant_and_cafe_ed_banner_section ) {
...
?>
	<div class="site-info">
		...
		<span class="by">
			<a href="<?php echo esc_url( 'http://haulo.fi	' ); ?>" rel="author" target="_blank"><?php echo esc_html__( 'PKK Theme by Mika Haulo', 'restaurant-and-cafe' ); ?></a>.
		</span>
	</div>
<?php
}
